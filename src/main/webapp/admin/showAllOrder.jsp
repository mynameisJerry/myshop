...
<script type="text/javascript">
    function sendOrder(id){
        ...
        if(res==true){
            window.location.href="${pageContext.request.contextPath }/order/sendOrder?oid="+id;
        }
    }
	$(function(){
		$("#search").click(function(){
			...
			location.href="${pageContext.request.contextPath}/order/searchOrder?username="+username+"&status="+status;
		})
	})
</script>
</head>
