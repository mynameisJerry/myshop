...
<script type="text/javascript">
	function deleteAddr(id){
		...
		if(res==true){
			window.location.href="${pageContext.request.contextPath }/address/deleteaddress?id="+id;
		}
	}
	function defaultAddr(id,level){
		var res = confirm("是否设为默认");
		if(res==true){
			window.location.href="${pageContext.request.contextPath }/address/defaultaddress?id="+id+"&level="+level;
    ...
    <div id="dingdanxiangqing_body_big">
     ...
     <div id="big_right" style="height: 500px;overflow: scroll;">
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="${pageContext.request.contextPath }/address/updateaddress" method="post" class="form-horizontal" style="padding:10px">
		...
		<div class="container" style="width:960px;">
			...
			<form action="${pageContext.request.contextPath }/address/addaddress" method="post" class="form-horizontal">
				<div class="form-group">
